...
#####################################################
#
# 's_name' and 'fixed_param' added. Parameters
# needed in 'scheduler.py' and 'optimize_DNN.py'
#



    result = module.main(job['id'], params,
                         s_name = job.get('summary_name','smry-file.dat'),
                         fixed_param = job.get('fixed_param',{})
                         )
