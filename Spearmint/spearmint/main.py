...
################### Edit
# Added **kwargs to pass 'expt_dir' from 'scheduler.py'
...
def get_summary_name():
    ...
    return '%s_%s_%s-%s_%s.dat' % tuple( date )
...
def main(**kwargs):
    ...
    options, expt_dir = get_options(**kwargs)
    ...
    while True:
        ...
        for resource_name, resource in resources.iteritems():
            ...
            while resource.acceptingJobs(jobs):
                ...
                ####### Edit
                print 'fixed parameter: ', str(fixed_param)
                if kwargs.has_key('max_jobs'): 
                    if float( suggested_job['id'] ) > float( kwargs['max_jobs'] ):
                        return summary_name
                ...
                if process_id is None:
                    ...
                    ####### Edit
                    suggested_job['summary_name'] = summary_name
                    suggested_job['fixed_param'] = fixed_param
